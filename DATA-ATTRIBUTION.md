...
SistemaHidrico aggregates publicly available data from many third-party sources.
...
SistemaHidrico itself is licensed under AGPL-3.0 (see `LICENSE`). **This file
...
**Attribution requirement:** the SistemaHidrico map UI displays
...
If you represent a data provider and have concerns about how SistemaHidrico
uses your data, please open an issue or contact the maintainer at
`Prof. César Rodríguez (https://github.com/cero97-ctrl)`. We will respond promptly and, if needed, adjust
