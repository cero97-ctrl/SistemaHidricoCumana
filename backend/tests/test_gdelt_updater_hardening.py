...
class TestUpdaterHardening:
    def test_validate_update_url_allows_github_codeload(self):
        url = "https://codeload.github.com/cero97-ctrl/SistemaHidricoCumana/zip/refs/tags/v1.2.3"
    ...
    def test_perform_update_surfaces_release_metadata(self, monkeypatch, tmp_path):
        release_url = "https://github.com/cero97-ctrl/SistemaHidricoCumana/releases/tag/v1.2.3"
        download_url = (
            "https://api.github.com/repos/cero97-ctrl/SistemaHidricoCumana/zipball/v1.2.3"
        )
