...
API_REGISTRY = [
    ...
    },
    {
        ...
        "description": "Paid Shodan API key for local operator-driven searches and temporary map overlays. Results are attributed to Shodan and are not merged into SistemaHidrico core feeds.",
