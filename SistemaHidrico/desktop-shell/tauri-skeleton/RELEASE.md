...
private key in `release-secrets/sistemahidrico-updater.key` and its local
password file in `release-secrets/sistemahidrico-updater.key.pass`, or provide
...
```text
https://github.com/cero97-ctrl/SistemaHidrico/releases/latest/download/latest.json
```
