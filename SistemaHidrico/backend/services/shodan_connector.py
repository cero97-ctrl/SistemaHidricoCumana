...
_USER_AGENT = "SistemaHidrico/0.9.75 local Shodan connector"
_REQUEST_TIMEOUT = 15
...
def get_shodan_connector_status() -> dict[str, Any]:
    ...
    return {
        ...
        "warning": (
            ...
            "your SistemaHidrico session by default, and any downstream use is your responsibility."
        ),
        "limits": {
...
def search_shodan(query: str, page: int = 1, facets: list[str] | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "note": "Operator-triggered Shodan results. Not part of SistemaHidrico core feeds.",
    }
...
def count_shodan(query: str, facets: list[str] | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "total": int(raw.get("total") or 0),
        "facets": _normalize_facets(raw.get("facets")),
        "note": "Count/facets query only. No persistent SistemaHidrico storage.",
    }
...
def lookup_shodan_host(ip: str, history: bool = False) -> dict[str, Any]:
    ...
    return {
        ...
        "note": "Operator-triggered Shodan host lookup. Not merged into SistemaHidrico datasets.",
    }
