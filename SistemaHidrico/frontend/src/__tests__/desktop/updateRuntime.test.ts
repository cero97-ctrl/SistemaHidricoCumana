...
const RELEASE: GitHubLatestRelease = {
  html_url: 'https://github.com/cero97-ctrl/SistemaHidrico/releases/tag/v0.9.75',
  assets: [
    { name: 'SistemaHidrico_0.9.75_x64_en-US.msi', browser_download_url: 'https://example.test/windows.msi' },
    { name: 'SistemaHidrico_0.9.75_x64-setup.exe', browser_download_url: 'https://example.test/windows-setup.exe' },
    { name: 'SistemaHidrico_0.9.75_aarch64.dmg', browser_download_url: 'https://example.test/macos.dmg' },
    { name: 'SistemaHidrico_0.9.75_amd64.AppImage', browser_download_url: 'https://example.test/linux.AppImage' },
  ],
};
