...
export default function GateView({
  ...
  const introMessage =
    GATE_INTROS[gateId] || 'Welcome to this gate. Be civil. The SistemaHidrico is watching.';
      ...
      <div className="border-b border-gray-800 pb-4 mb-4 shrink-0">
        <div className="flex items-center justify-between mb-2">
          ...
          <div className="text-gray-500 text-xs">
            ...
            <span
              className={
                persona === 'sistemahidrico' ? 'text-red-500 animate-pulse font-bold' : 'text-green-400'
              }
            >
              {persona}
            </span>
