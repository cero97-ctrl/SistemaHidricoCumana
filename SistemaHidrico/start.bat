@echo off
title SistemaHidrico - Monitoreo Hidrico

echo ===================================================
echo   S I S T E M A H I D R I C O   --   STARTUP
echo ===================================================
echo.
...
if %errorlevel% equ 0 (
    ...
    echo     git clone https://github.com/cero97-ctrl/SistemaHidricoCumana.git
    echo     cd SistemaHidricoCumana
...
start "SistemaHidrico Runtime" powershell.exe -NoProfile -ExecutionPolicy Bypass -NoExit -File "%ROOT%\scripts\run-windows-runtime.ps1" -Root "%ROOT%"
exit /b 0

echo.
echo ===================================================
echo   SistemaHidrico has stopped. Check errors above.
echo ===================================================
pause
