...
export interface SistemaHidricoLocalControlBridge {
...
function getDesktopBridge(): SistemaHidricoLocalControlBridge | null {
  if (typeof window === 'undefined') return null;
  return window.__SISTEMAHIDRICO_LOCAL_CONTROL__ || null;
}
