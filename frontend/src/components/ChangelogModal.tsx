...
const STORAGE_KEY = `sistemahidrico_changelog_v${CURRENT_VERSION}`;
...
const HEADLINE_FEATURES = [
  ...
  },
  {
    ...
    subtitle: 'SistemaHidrico now exposes a signed agent command channel. Bring your own agent (OpenClaw, Claude Code, GPT, LangChain, or a custom client) and drive the dashboard from any LLM that speaks the protocol.',
    details: [
      ...
      'SistemaHidrico does not bundle an LLM, an agent runtime, or model weights — it ships the protocol. Any agent that signs requests with the documented HMAC contract can connect. OpenClaw is the reference implementation.',
    ],
