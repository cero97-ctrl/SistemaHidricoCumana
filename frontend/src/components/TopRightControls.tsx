...
const DEFAULT_RELEASES_URL = 'https://github.com/cero97-ctrl/SistemaHidrico/releases/latest';
...
const DESKTOP_UPDATER_DETAIL =
  'This packaged desktop app can install the signed update in place. It will restart SistemaHidrico after the installer finishes.';
  ...
  const checkForUpdates = async () => {
    ...
    try {
      ...
      const res = await fetch(
        'https://api.github.com/repos/cero97-ctrl/SistemaHidrico/releases/latest',
      );
      ...
      try {
        ...
        setErrorMessage(
          message === 'desktop_update_installed_restart_required'
            ? 'Update installed. Restart SistemaHidrico to finish applying it.'
