...
LOCAL_UPDATER_KEY="$REPO_ROOT/release-secrets/sistemahidrico-updater.key"
LOCAL_UPDATER_KEY_PASSWORD="$REPO_ROOT/release-secrets/sistemahidrico-updater.key.pass"
CLEAN=0
...
echo "=== SistemaHidrico Tauri Build ==="
