...
const HELP_TEXT = `
SistemaHidrico DM root health Prometheus exporter
...
Environment:
  ...
  SB_DM_ROOT_PROMETHEUS_OUTPUT=/var/lib/node_exporter/textfile_collector/sistemahidrico_dm_root.prom
...
function buildMetrics(payload, errorDetail = '') {
  ...
  appendMetric(
    lines,
    'sistemahidrico_dm_root_health_scrape_success',
  ...
  appendMetric(
    lines,
    'sistemahidrico_dm_root_checked_at_unixtime',
  ...
  appendMetric(
    lines,
    'sistemahidrico_dm_root_summary_state_code',
  ...
  appendMetric(
    lines,
    'sistemahidrico_dm_root_health_state_code',
  ...
  appendMetric(
    lines,
    'sistemahidrico_dm_root_monitor_state_code',
  ...
  appendMetric(
    lines,
    'sistemahidrico_dm_root_strong_trust_blocked',
  ...
  appendMetric(
    lines,
    'sistemahidrico_dm_root_external_assurance_current',
  ...
  appendMetric(
    lines,
    'sistemahidrico_dm_root_requires_attention',
  ...
  appendMetric(
    lines,
    'sistemahidrico_dm_root_independent_quorum_met',
  ...
  appendMetric(
    lines,
    'sistemahidrico_dm_root_alert_count',
  ...
  appendMetric(
    lines,
    'sistemahidrico_dm_root_blocking_alert_count',
  ...
  appendMetric(
    lines,
    'sistemahidrico_dm_root_warning_alert_count',
  ...
  appendMetric(
    lines,
    'sistemahidrico_dm_root_witness_state_code',
  ...
  appendMetric(
    lines,
    'sistemahidrico_dm_root_witness_health_state_code',
  ...
  appendMetric(
    lines,
    'sistemahidrico_dm_root_witness_age_seconds',
  ...
  appendMetric(
    lines,
    'sistemahidrico_dm_root_witness_warning_window_seconds',
  ...
  appendMetric(
    lines,
    'sistemahidrico_dm_root_witness_freshness_window_seconds',
  ...
  appendMetric(
    lines,
    'sistemahidrico_dm_root_witness_reacquire_required',
  ...
  appendMetric(
    lines,
    'sistemahidrico_dm_root_witness_manifest_matches_current',
  ...
  appendMetric(
    lines,
    'sistemahidrico_dm_root_witness_independent_quorum_met',
  ...
  appendMetric(
    lines,
    'sistemahidrico_dm_root_transparency_state_code',
  ...
  appendMetric(
    lines,
    'sistemahidrico_dm_root_transparency_health_state_code',
  ...
  appendMetric(
    lines,
    'sistemahidrico_dm_root_transparency_age_seconds',
  ...
  appendMetric(
    lines,
    'sistemahidrico_dm_root_transparency_warning_window_seconds',
  ...
  appendMetric(
    lines,
    'sistemahidrico_dm_root_transparency_freshness_window_seconds',
  ...
  appendMetric(
    lines,
    'sistemahidrico_dm_root_transparency_verification_required',
  ...
  appendMetric(
    lines,
    'sistemahidrico_dm_root_summary_info',
  ...
  if (nextAction) {
    appendMetric(
      lines,
      'sistemahidrico_dm_root_next_action_info',
  ...
  if (errorDetail) {
    appendMetric(
      lines,
      'sistemahidrico_dm_root_health_scrape_error_info',
  ...
  for (const alert of alerts) {
    ...
    appendMetric(
      lines,
      'sistemahidrico_dm_root_alert_active',
