# SistemaHidrico — Meshtastic MQTT Remediation

**Version:** 0.9.6  
**Date:** 2026-04-12  
**Re:** [meshtastic/firmware#6131](https://github.com/meshtastic/firmware/issues/6131) — Excessive MQTT traffic from SistemaHidrico clients

---

## What happened

SistemaHidrico is an open-source OSINT situational awareness platform that includes a Meshtastic MQTT listener for displaying mesh network activity on a global map. In prior versions, the MQTT bridge:
...
Client IDs changed from `sbmesh-{uuid}` to `sb096-{uuid}` so the Meshtastic team can identify SistemaHidrico clients and track adoption of the fix by version.
...
Repository: [github.com/cero97-ctrl/SistemaHidricoCumana](https://github.com/cero97-ctrl/SistemaHidricoCumana)  
Maintainer: cero97-ctrl
